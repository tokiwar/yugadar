  ...
  async asyncData({$axios, route}) {
    const meta = [
      ...
      },
      {
        hid: 'og:description',
        name: 'og:description',
        content: 'Мороженое от кубанского производителя «ЮгаДар» - Мороженое. Ассортимент мороженого и объемы продажи. Купить мороженое в Тимашевске.'
      },
      {
        hid: 'description',
        name: 'description',
      ...
      },
      {
        hid: 'keywords',
        name: 'keywords',
        content: 'купить, мороженое, пломбир, цена, ассортименте, тара, тимашевск, краснодарский край'
      }
    ];
